...
if (import.meta.env.VITE_SUPABASE_PUBLISHABLE_DEFAULT_KEY === undefined) {
  throw new Error("Please set the VITE_SUPABASE_PUBLISHABLE_DEFAULT_KEY environment variable");
}
